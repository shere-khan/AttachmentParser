...
if __name__ == '__main__':
    ...
    dlf.set_type_federal_action(AP.extract_text(AP.get_lobbying_activities_disc_text()
                                               + AP.get_sflll_1_2_ns_text() + 'FederalActionType', root, ns))
    dlf.set_award_amount(AP.extract_text(AP.get_lobbying_activities_disc_text()
                                   + AP.get_sflll_1_2_ns_text() + 'AwardAmount', root, ns))
    dlf.set_cfda_number(cfda_number = AP.extract_text(AP.get_lobbying_activities_disc_text()
                                  + AP.get_federal_program_name_text() + AP.get_sflll_1_2_ns_text() + 'CFDANumber', root, ns))
    dlf.set_fdrl_action_number(AP.extract_text(AP.get_lobbying_activities_disc_text()
                                         + AP.get_sflll_1_2_ns_text() + 'FederalActionNumber', root, ns))
    dlf.set_fdrl_agency_dept(AP.extract_text(AP.get_lobbying_activities_disc_text()
                                       + AP.get_sflll_1_2_ns_text() + 'FederalAgencyDepartment', root, ns))
    ...
    dlf.set_fdrl_program_name(AP.extract_text(AP.get_lobbying_activities_disc_text() + 
                                        AP.get_federal_program_name_text() + AP.get_federal_program_name_text(), root, ns))
    dlf.set_last_report_date(AP.extract_text(AP.get_lobbying_activities_disc_text()
                                             + '/MaterialChangeSupplement/LastReportDate', root, ns))
    dlf.set_lobby_reg_address_city(AP.extract_text(AP.get_lobby_reg_text() + AP.get_sflll_1_2_ns_text() + 'City', root, ns))
    dlf.set_lobby_reg_address_state(AP.extract_text(AP.get_lobby_reg_text() + AP.get_sflll_1_2_ns_text() + 'State', root, ns))
    dlf.set_lobby_reg_address_street1(AP.extract_text(AP.get_lobby_reg_text() + AP.get_sflll_1_2_ns_text() + 'Street1', root, ns))
    dlf.set_lobby_reg_address_street2(AP.extract_text(AP.get_lobby_reg_text() + AP.get_sflll_1_2_ns_text() + 'Street2', root, ns))
    dlf.set_lobby_reg_address_zip(AP.extract_text(AP.get_lobby_reg_text() + AP.get_sflll_1_2_ns_text() + 'ZipPostalCode', root, ns))
    dlf.set_lobby_reg_name_first(AP.extract_text(AP.get_lobby_reg_text() + AP.get_sflll_1_2_ns_text() + 'FirstName', root, ns))
    dlf.set_lobby_reg_name_last(AP.extract_text(AP.get_lobby_reg_text() + AP.get_sflll_1_2_ns_text() + 'LastName', root, ns))
    dlf.set_lobby_reg_name__middle(AP.extract_text(AP.get_lobby_reg_text() + '/MiddleName', root, ns))
    dlf.set_lobby_reg_name_last(AP.extract_text(AP.get_lobby_reg_text() + '/PrefixName', root, ns))
    dlf.set_lobby_reg_name_suffix(AP.extract_text(AP.get_lobby_reg_text() + '/SuffixName', root, ns))
    dlf.set_material_change_qtr(material_change_qtr = AP.extract_text(AP.get_lobbying_activities_disc_text()
                                          + '/MaterialChangeSupplement/MaterialChangeQuarter', root, ns))
    dlf.set_material_change_year(AP.extract_text(AP.get_lobbying_activities_disc_text()
                                           + '/MaterialChangeSupplement/MaterialChangeYear"', root, ns))
    dlf.set_prime_re_address_city(AP.extract_text(AP.get_prime_text() + '/City', root, ns))
    dlf.set_prime_re_address_state(AP.extract_text(AP.get_prime_text() + '/State', root, ns))
    dlf.set_prime_re_address_street1(AP.extract_text(AP.get_prime_text() + '/Street1', root, ns))
    dlf.set_prime_re_address_street2(AP.extract_text(AP.get_prime_text() + '/Street2', root, ns))
    dlf.set_prime_re_address_zip(AP.extract_text(AP.get_prime_text() + '/ZipPostalCode', root, ns))
    dlf.set_prime_re_cong_dist(AP.extract_text(AP.get_prime_text() + '/CongressionalDistrict', root, ns))
    dlf.set_prime_re_org_name(AP.extract_text(AP.get_prime_text() + '/OrganizationName', root, ns))
    dlf.set_re_is_prime(AP.extract_text(AP.get_prime_text() + '/ReportEntityIsPrime', root, ns))
    dlf.set_report_type(AP.extract_text(AP.get_lobbying_activities_disc_text() + '/ReportType', root, ns))
    dlf.set_sig_blk_date(AP.extract_text(AP.get_sig_block_text() + '', root, ns))
    dlf.set_sig_blk_name_first(AP.extract_text(AP.get_sig_block_text() + '', root, ns))
    dlf.set_sig_blk_name_last(AP.extract_text(AP.get_sig_block_text() + '', root, ns))
    dlf.set_sig_blk_name_middle(AP.extract_text(AP.get_sig_block_text() + '', root, ns))
    dlf.set_sig_blk_name_prefix(AP.extract_text(AP.get_sig_block_text() + '', root, ns))
    dlf.set_sig_blk_name_suffix(AP.extract_text(AP.get_sig_block_text() + '', root, ns))
    dlf.set_sig_blk_phone(AP.extract_text(AP.get_sig_block_text() + '', root, ns))
    dlf.set_sig_blk_signature(AP.extract_text(AP.get_sig_block_text() + '', root, ns))
    dlf.set_sig_blk_title(AP.extract_text(AP.get_sig_block_text() + '', root, ns))
    dlf.set_status_federal_action(AP.extract_text(AP.get_lobbying_activities_disc_text() + '/FederalActionStatus', root, ns))
    # tier_value = AP.extract_text(AP.get_lobbying_activities_disc_text() + '/ReportEntity/Tier/TierValue', root, ns)
    dlf.set_type_federal_action(AP.extract_text(AP.get_lobbying_activities_disc_text() + '/FederalActionType', root, ns))
